...
describe('Testing HOC component functions:', () => {
  it('1. Checks if console.log was called on mount and on unmount with Component', () => {
  ...
  it('2. Checks if console.log was called on mount and unount with the name of "Login" component', () => {
