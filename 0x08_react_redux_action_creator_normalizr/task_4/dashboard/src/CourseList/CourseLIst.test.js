...
describe('Testing CourseList.js Functions:', () => {
  ...
  it('1. CourseList without crashing', () => {
  ...
  it('3. Verify that CourseList renders correctly', () => {
  ...
  // it('4. verify the CourseList renders input courses correctly without errors', () => {
  //   const wrapper = shallow(<CourseList listCourses={listCourses}/>);
